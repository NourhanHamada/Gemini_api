...
class __$$FailImplCopyWithImpl<T, $Res>
    extends _$AppStateCopyWithImpl<T, $Res, _$FailImpl<T>>
...
class _$FailImpl<T> implements Fail<T> {
  ...
  @override
  String toString() {
    return 'AppState<$T>.fail()';
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$FailImpl<T>);
  }
...
abstract class Fail<T> implements AppState<T> {
  const factory Fail() = _$FailImpl<T>;
}
